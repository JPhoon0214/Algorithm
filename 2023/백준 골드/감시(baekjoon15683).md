...
>### 문제
> <a href="https://www.acmicpc.net/problem/15683">문제 바로 가기(baekjoon 15683)</a>
...
>### 회고
>>난이도에 비해 구현이 조금 어려웠던 것 같다. 어떻게 구현할지 고민하다 어쩔 수 없이 일일히 함수로 만들어 구현했다.난이도에 비해 구현이 조금 어려웠다.  
>>왠지 모르겠는데 커밋이 꼬인다.
